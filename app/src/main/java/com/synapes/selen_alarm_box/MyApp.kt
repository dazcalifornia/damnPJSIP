...
interface MyAppObserver {
    ...
    fun notifyChangeNetwork(status: String?)
}
...
class MyCall(acc: MyAccount?, call_id: Int) : Call(acc, call_id) {
    ...
    override fun onCallState(prm: OnCallStateParam) {
        try {
            ...
            Log.e("MyCall", "Error onCallState: $e")
        }
    ...
    override fun onCallMediaState(prm: OnCallMediaStateParam) {
        ...
        ci = try {
            ...
            Log.e("MyCall", "Error onCallMediaState: $e")
            return
        }
        val cmiv = ci.media
...
class MyAccount(var cfg: AccountConfig) : Account() {
    ...
    fun addBuddy(bud_cfg: BuddyConfig): MyBuddy? {
        ...
        try {
            ...
            Log.e("MyAccount", "Error creating buddy: $e")
            bud?.delete()
            bud = null
        }
        if (bud != null) {
            ...
            if (bud_cfg.subscribe) try {
                ...
                Log.e("MyAccount", "Error subscribing buddy: $e")
            }
        }
        return bud
    }
    ...
    override fun onIncomingCall(prm: OnIncomingCallParam) {
        ...
        Log.d("MyAccount", "Incoming call from " + call.info.remoteUri)
    ...
    override fun onInstantMessage(prm: OnInstantMessageParam) {
        ...
        Log.d("MyAccount", "Pager from " + prm.fromUri + ": " + prm.msgBody)
    }

    fun isRegistrationActive(): Boolean {
        return try {
            val accInfo = info
            Log.d("MyAccount", " *** Registration state: ${accInfo.regIsActive}")
            accInfo.regIsActive
        } catch (e: Exception) {
            Log.e("MyAccount", "Error getting registration state: $e")
            false
        }
    }
}
    ...
    val statusText: String?
        get() {
            ...
            bi = try {
                ...
                Log.e("MyBuddy", "Error getting buddy info: $e")
                return "?"
            }
            var status: String? = ""
...
internal class MyAccountConfig {
    ...
    fun readObject(node: ContainerNode) {
        try {
            ...
            Log.e("MyAccountConfig", "Error reading account config: $e")
        }
    }
    ...
    fun writeObject(node: ContainerNode) {
        try {
            ...
            Log.e("MyAccountConfig", "Error writing account config: $e")
        }
    }
}
...
class MyApp {
    ...
    fun init(
        ...
        try {
            ...
            Log.e(TAG, "Error creating endpoint: $e")
            return
        }
        ...
        Log.d(TAG, " Config path: $configPath, absolute path: ${f.absolutePath}")
        ...
        try {
            ...
            Log.e(TAG, "Error initializing endpoint: $e")
            return
        }
        ...
        try {
            ...
            println(e)
            Log.e(TAG, "Error creating UDP transport: $e")
        }
        try {
            ep?.transportCreate(
            ...
            println(e)
            Log.e(TAG, "Error creating TCP transport: $e")
        }
        try {
            ...
            println(e)
            Log.e(TAG, "Error creating TLS transport: $e")
        }
        ...
        for (i in accCfgs.indices) {
            ...
            my_cfg.accCfg.natConfig.iceEnabled = false
        ...
        try {
            ...
            Log.e(TAG, "Error starting endpoint: $e")
            return
        }
    }
...
//            Log.d(TAG, "Network change detected")
            ...
            println(e)
            Log.d(TAG, "Error handling network change: $e")
        }
    }
    ...
    fun isLibraryStarted(): Boolean {
        try {
            ...
            println(e)
            Log.e(TAG, "Error checking library state: $e")
        }
        return false
    }
    ...
    fun deinit() {
        ...
        try {
            ...
            Log.e(TAG, "Error destroying endpoint: $e")
        }
